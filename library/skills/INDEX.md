...
commit and patched where it named something that does not exist here. `choose-automation-approach` and
`scan-agent-skill` were authored for this workspace. `CANON.md` records both kinds explicitly.
