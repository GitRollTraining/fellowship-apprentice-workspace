...
specification is written. Confirmed, it enters the PRD and its specification row carries
`in-data <- <file and field>`. Unconfirmed, it becomes a row in `interview/ambiguities.md` and does not
